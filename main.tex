...
\begin{tabular}{ccccc}
    Problema agli autovalori & \multicolumn{2}{c}{Definizioni utili} & Nuovo probl. agli autov. & Autostati \\
    ...
    \multicolumn{2}{c}{$\displaystyle u_n(x) = \left[\frac{1}{n!2^n}\left(\frac{\hbar}{m\omega}\right)\right]^\frac{1}{2} \left(\frac{m\omega}{\pi\hbar}\right)^\frac{1}{4}\left[\frac{m\omega}{\hbar}x-\frac{\mathrm{d}}{\mathrm{d}x}\right]^n e^{-\frac{m\omega}{\hbar}\frac{x^2}{2}} $} & $[a,a^\dagger] = 1 $
\end{tabular}

...
\begin{tabular}{*{5}{c}}
    ...
    \cline{1-4}
    \multicolumn{1}{c|}{Formule Eulero} & \multicolumn{1}{c|}{Integrale di D'Eramo} & & \multicolumn{1}{c|}{} & $\sin^2 \theta = \frac{1-\cos 2\theta}{2} $ \\
    \multicolumn{1}{c|}{$\sin\theta = \frac{e^{i\theta}-e^{-i\theta}}{2i} $} & \multicolumn{1}{c|}{$\int_\mathbb{R} \mathrm{d}x\, e^{-\alpha x^2 + \beta x} = \frac{\sqrt{\pi}}{\alpha}e^{\frac{\beta^2}{4\alpha}} $} & & \multicolumn{1}{c|}{} & $\cos^2 \theta = \frac{1+\cos 2\theta}{2} $ \\
    \cline{2-2} \cline{5-5}
